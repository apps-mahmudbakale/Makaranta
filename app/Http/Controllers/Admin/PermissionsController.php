...
class PermissionsController extends Controller
{
    ...
    {
        abort_unless(\Gate::allows('permission_read'), 403);
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        $permission = $request->input('title');

        $permissions = array($permission.'_create', $permission.'_read', $permission.'_edit', $permission.'_delete');
